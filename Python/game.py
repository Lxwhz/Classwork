...
def handle_bullets(yellow_bullets, red_bullets, yellow, red, keys_pressed):
    for bullet in yellow_bullets:
        bullet.x += BULLET_VEL
...
def draw_winner(text, WINNER_FONT= 'Ariel'):
...
def main():
    ...
    while run:
        ...
        handle_bullets(yellow_bullets, red_bullets, yellow, red, keys_pressed)
